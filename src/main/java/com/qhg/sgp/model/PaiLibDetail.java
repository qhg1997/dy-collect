...
@Data
@Entity
@Table(name = "pai_lib_detail")
public class PaiLibDetail {/*解说*/
    @Id
    ...
    public static void main(String[] args) {
        ...
        List<PaiLibDetail> pais = JSONArray.parseArray(list.toJSONString(), PaiLibDetail.class);
