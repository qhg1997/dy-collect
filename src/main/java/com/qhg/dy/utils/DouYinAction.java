...
public class DouYinAction {
    ...
    private static void parseUrl() {
        String a = "?device_platform=webapp&aid=6383&channel=channel_pc_web&sec_user_id=MS4wLjABAAAA9i2T7hxelvEABSl_xGN3u9d_X4x04n4neSDo7P-rDVs&max_cursor=1596514387000&locate_query=false&show_live_replay_strategy=1&count=10&publish_video_strategy_type=2&pc_client_type=1&version_code=170400&version_name=17.4.0&cookie_enabled=true&screen_width=1920&screen_height=1080&browser_language=zh-CN&browser_platform=Win32&browser_name=Edge&browser_version=110.0.1587.50&browser_online=true&engine_name=Blink&engine_version=110.0.0.0&os_name=Windows&os_version=10&cpu_core_num=8&device_memory=8&platform=PC&downlink=10&effective_type=4g&round_trip_time=50&webid=7202623704786241061&msToken=DdssctqyIkoXmgE9sHzpkMXaw99WOmkV-039sRkH8K8ML2FGDT7tOIm9kL6RhqfetYjyFA7yrngneCv9tysMBXKSuUiFgc5kRFOES45RcMMctfHwfHQcV8APtUMp8zo=&X-Bogus=DFSzswVElgUANtqESghtU2oB6lK0";
        String url = "" +
